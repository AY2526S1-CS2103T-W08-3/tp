...
import static seedu.address.logic.Messages.MESSAGE_NO_USERS_FOUND;
...
public class LogicManagerTest {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + STUDENT_NOTE_DESC_AMY;
        ModelManager expectedModel = new ModelManager();

        assertThrows(CommandException.class, expectedMessage, () -> logic.execute(addCommand));
        Person p = model.getAddressBook().getPersonList().get(0);

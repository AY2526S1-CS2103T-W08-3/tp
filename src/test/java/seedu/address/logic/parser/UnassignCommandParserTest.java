...
/**
 * Contains tests for {@code UnassignCommandParser}.
 */
public class UnassignCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_AMY + " i1/1" + DAY_DESC_MATH + " i2/2",
                new UnassignCommand(expectedName, FIRST_INDEX, expectedDay, SECOND_INDEX));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + DAY_DESC_MATH,
                new UnassignCommand(expectedName, null, expectedDay, null));

        // no i2 only
        assertParseSuccess(parser, NAME_DESC_AMY + " i1/1" + DAY_DESC_MATH,
                new UnassignCommand(expectedName, FIRST_INDEX, expectedDay, null));
    }
    ...
    public void parse_repeatedValue_failure() {
        String validExpectedUnassignString = NAME_DESC_AMY + " i1/1" + DAY_DESC_MATH + " i2/2";

        // multiple names
        assertParseFailure(parser, NAME_DESC_BOB + validExpectedUnassignString,
        ...
        assertParseFailure(parser,
                validExpectedUnassignString + NAME_DESC_BOB + " i1/2" + DAY_DESC_SCIENCE + " i2/3",

...
public abstract class FilterCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            ...
            + "filter n/NAME INDEX filters the list of lessons by the specified student, while "
            + "filter d/DAY INDEX filters the list of students by the specified lesson.\n"
            + "Omitting the INDEX parameter for either displays the referenced list of students or lessons.\n"
            + "Example: " + COMMAND_WORD + " n/John 2 or " + COMMAND_WORD + " d/Mon 2.";
}

...
public class AssignCommand extends Command {
    ...
    public static final String MESSAGE_LIST_PERSONS_WITH_NAME = "Here is the list of students "
            + "containing: \"%s\". Enter \"assign n/%s i1/{i1} d/%s \" to view lessons you can assign to student {i1} from %s.";
    public static final String MESSAGE_LIST_LESSONS_WITH_DAY = "Here is the list of lessons "
            + "on: \"%s\". Enter \"assign n/%s i1/%s d/%s i2/{i2} \" to assign the student to the lesson and vice versa.";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (studentIndex == null) {
            ...
            return new CommandResult(String.format(MESSAGE_LIST_PERSONS_WITH_NAME, name, name, day, day), false, false, false);
        }
        ...
        if (lessonIndex == null) {
            ...
            return new CommandResult(String.format(MESSAGE_LIST_LESSONS_WITH_DAY, day, name, studentIndex.getOneBased(), day),
                    false, false, true);
        }

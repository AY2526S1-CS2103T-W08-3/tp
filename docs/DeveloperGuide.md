...
* GitHub Copilot was used in the creation and generation of test cases.
...
**`Main`** (consisting of classes [`Main`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/Main.java) and [`MainApp`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/MainApp.java)) is in charge of the app launch and shut down.
...
The *Sequence Diagram* below shows how the components interact with each other for the scenario where the user issues the command `deletestudent n/Alex i/1`.
...
The **API** of this component is specified in [`Ui.java`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/ui/Ui.java)

![Structure of the UI Component](images/UiClassDiagram.png)

The UI consists of a `MainWindow` that is made up of parts e.g.`CommandBox`, `ResultDisplay`, `PersonListPanel`, `StatusBarFooter` etc. All these, including the `MainWindow`, inherit from the abstract `UiPart` class which captures the commonalities between classes that represent parts of the visible GUI.

The `UI` component uses the JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files that are in the `src/main/resources/view` folder. For example, the layout of the [`MainWindow`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/ui/MainWindow.java) is specified in [`MainWindow.fxml`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/resources/view/MainWindow.fxml)
...
**API** : [`Logic.java`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/logic/Logic.java)
...
### Model component
**API** : [`Model.java`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/model/Model.java)
...
**API** : [`Storage.java`](https://github.com/AY2526S1-CS2103T-W08-3/tp/blob/master/src/main/java/seedu/address/storage/Storage.java)
...
| `* * *`  | private tutor | create lessons                                | assign students to a lesson                                      |
| `* *`    | private tutor | edit lessons' details                         | correct any mistakes in content                                  |
| `* * *`  | private tutor | delete lessons                                | remove a lesson that I am no longer teaching                     |
